...
public class DataForSendToPrinterPos80 {
    ...
    public static byte[] printContent(String content) {
        byte[] text = strTobytes(content);
        return text;
    }
    ...
    public static byte[] StoresSymbolDataInTheQRCodeSymbolStorageArea(String code) {
        ...
        byte[] data = new byte[]{29, 40, 107, 48, -128, (byte) pL1, (byte) pH1};
        data = byteMerger(data, b);
        return data;
    }
    ...
    public static byte[] printQRcode(int n, int errLevel, String code) {
        ...
        byte[] data = new byte[]{29, 40, 107, 48, 103, (byte) n, 29, 40, 107, 48, 105, (byte) errLevel, 29, 40, 107, 48, -128, (byte) nL1, (byte) nH1};
        data = byteMerger(data, b);
    ...
    private static byte[] strTobytes(String str) {
        ...
        try {
            ...
            data = (new String(b1, "utf-8")).getBytes(charsetName);
