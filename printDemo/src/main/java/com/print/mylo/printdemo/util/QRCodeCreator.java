...
public class QRCodeCreator {
     ...
     * @return 返回bitmap
     */
    public static Bitmap createQRCodeBitmap(String content) throws WriterException {
        // 用于设置QR二维码参数
    ...
    public static Bitmap createLogoCode(String content, Bitmap logoBitmap)
